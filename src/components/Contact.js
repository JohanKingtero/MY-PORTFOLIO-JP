       ...
       <div className='flex flex-col lg:flex-row'>
        ...
        <motion.div
         ...
         className='flex-1 flex justify-start items-center'>
          <div>
            <h4 className='text-xl uppercase text-accent font-medium mb-2 tracking-wide'>PONTE EN CONTACTO CONMIGO</h4>
            <h2 className='text-[45px] lg:text-[90px] leading-none mb-12'>Vamos a trabajar <br/>JUNTOS</h2>
          </div>
        </motion.div>
        {/*form*/}
        <motion.form
         ...
         className='flex-1 border rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start'>
          ...
          <input className='bg-transparent border-b py-3 outline-none w-full placeholder:text-white focus:border-accent transition-all' type='text' placeholder='Tu Correo Electronico' />
